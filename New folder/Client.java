...
Scanner scanner = new Scanner(System.in);
  ...
  } while( login.equals( "Feli" ) == false || password.equals( "esiea" ) == false );
  
  System.out.println( "Bonjour  Felicia, Authentification Accepter" );            
 ...
 System.out.println("weekend en ecoute");
 Playmusic mb_745 = new Playmusic("F:/music/the-weeknd1.wav");
 System.out.println("ecoute terminer");
 System.out.println("weekend Bliding Light");
 Playmusic mb_746 = new Playmusic("F:/music/the-weeknd.wav");
 System.out.println("ecoute terminer");
 System.out.println("ninho");
 //Playmusic mb_747 = new Playmusic("F:/music/ninho.wav");
 //ystem.out.println("ecoute terminer");
...
public static void signout(){
  ...
  Scanner scanner=new Scanner(System.in);
  String response2;
  System.out.println("diconnected or conected");
